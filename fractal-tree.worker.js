// fractal-tree.worker.js (anchored + adaptive)
// Receives: init {canvas,width,height,dpr,opts}, resize {width,height,dpr},
// updateOptions {opts}, updateAnchorPx {ax,ay}, start/stop
